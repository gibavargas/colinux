...
RUN adduser -D -s /bin/bash -h /home/codex codex && \
    ...
    echo "codex ALL=(root) NOPASSWD: /usr/local/bin/codex-disk-inventory, /usr/local/bin/codex-network, /usr/local/bin/codex-backup, /usr/local/bin/codex-restore, /usr/local/bin/codex-update, /usr/local/bin/codexctl, /usr/local/bin/codex-logs, /usr/local/bin/codex-mount-rw, /usr/local/bin/codex-mount-ro, /usr/local/bin/codex-usb-persist, /usr/local/bin/codex-hw-check, /usr/local/bin/codex-benchmark, /usr/local/bin/codex-clone, /usr/local/bin/codex-recover" > /etc/sudoers.d/codex && \
